function rh_InitOptions(){
        document.getElementById("autoquell").addEventListener("click",rh_aqv,true);
        ...
        try{
            ...
            document.getElementById("autoquell").checked=E.getBoolPref("extensions.rh.autoquell");
            document.getElementById("aqv").value=E.getCharPref("extensions.rh.aqv");
...
function rh_SaveOptions(){
        try{
            ...
            D.setBoolPref("extensions.rh.autoquell",document.getElementById("autoquell").checked);
            D.setCharPref("extensions.rh.aqv",parseFloat(document.getElementById("aqv").value));
...
function rh_aqv(){
        if(document.getElementById("autoquell").checked){
            document.getElementById("aqcancel").disabled=false
            document.getElementById("aqv").disabled=false
        } else {
            document.getElementById("aqcancel").disabled=true
            document.getElementById("aqv").disabled=true
        }
    }
function rh_ptv(){
